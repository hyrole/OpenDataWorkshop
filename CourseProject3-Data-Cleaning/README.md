...
6. Source: https://class.coursera.org/getdata-006/human_grading/index

Run attached script (run_analysis.R) will download required data from the dataset link. Result will be formatted tidy data downloaded to your working directory